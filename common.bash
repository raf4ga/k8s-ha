...
# IP RANGES
#
export NODES_INTERNAL_NET=172.31.222.0/24
...
export CONTROLLER_PUBLIC_IP=54.161.105.168
export CONTROLLER_PRIVATE_IP=172.31.222.98
export CONTROLLER_HOSTNAME=controller1

export CONTROLLER2_PUBLIC_IP=34.239.121.246
export CONTROLLER2_PRIVATE_IP=172.31.222.161
export CONTROLLER2_HOSTNAME=controller2

export WORKER0_PUBLIC_IP=54.82.235.95
export WORKER0_PRIVATE_IP=172.31.222.236
export WORKER0_HOSTNAME=worker1

export WORKER1_PUBLIC_IP=34.205.143.151
export WORKER1_PUBLIC_IP=172.31.222.239
export WORKER1_HOSTNAME=worker2
